  ...
  .setPanelOptions(builder => {
    return builder
      ...
      .addSelect({
        path: 'pieOptions',
        name: 'PieRadius type',
        description: 'StraightAnglePieChart or PieChartWithPaddingAngle.',
        defaultValue: 'StraightAnglePieChart',

        settings: {
          options: [
            { label: 'StraightAnglePieChart', value: '0' },
            { label: 'PieChartWithPaddingAngle', value: '60' },
          ],
        },
      })
      .addCustomEditor({
